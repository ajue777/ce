...
class v61(IStrategy):
    """
    Strategy using RSI and ADX indicators with pyramid position sizing
    ...
    Exit:
    - 1h ADX < previous 1h ADX
    - 1h ADX > 40
    
    Position increase:
    - After first entry
    - Price dropped by 5%
    - ADX decreasing but > 48
    """
    ...
    max_entry_position_adjustment = 2  # Maximum number of additional entries
    pyramid_max_open_trades = 3  # Maximum number of open trades per pair
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (dataframe['rsi_1h'] < 25) &  # 1h RSI6 < 25
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (dataframe['adx_prev_1h']==True) &  # Current 1h ADX < previous 1h ADX
                (dataframe['adx'] > 48) &  # 1h ADX > 40
                (dataframe['volume'] > 0)  # Make sure volume is not 0
            ),
            'exit_long'] = 1
    ...
    def custom_stake_amount(self, pair: str, current_time: datetime, current_rate: float,
        ...
        """
        Implement pyramid position sizing
        """
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime,
        ...
        if trade.nr_of_successful_entries >= 1:
            ...
            adx_condition = (last_candle['adx'] < previous_candle['adx']) and (last_candle['adx'] > 48)
