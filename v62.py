...
class v62(IStrategy):    
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime,
        ...
        if trade.nr_of_successful_entries >= 1:
            ...
            adx_condition = (dataframe['rsi'] < 13) and (dataframe['adx'] > 47)
            
            if (price_drop >= 0.085) and adx_condition:
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['rsi_1h'] < 25) & (dataframe['rsi'] < 25), 'rsi_triggered'] = True
